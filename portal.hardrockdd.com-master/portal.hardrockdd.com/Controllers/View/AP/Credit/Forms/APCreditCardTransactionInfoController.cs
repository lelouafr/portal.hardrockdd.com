...
{
    [ControllerAuthorize]
    public class APCreditCardTransactionInfoController : BaseController
    {        

        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(InfoViewModel model)
        {
        ...
        [HttpGet]
        public JsonResult ValidateHeader(InfoViewModel model)
        {
            //ModelState.Clear();
