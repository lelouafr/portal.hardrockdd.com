...
{
    [ControllerAuthorize]
    public class MerchantCategoryInfoController : BaseController
    {
        [HttpGet]
        public ActionResult Form(byte vendGroupId, string categoryGroup, int categoryCodeId)
        {
            ...
            return PartialView("../AP/Vendor/MerchantCategory/Forms/Info/Form", results);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(MerchantCategoryInfoViewModel model)
        {
        ...
        [HttpGet]
        public JsonResult Validate(MerchantCategoryInfoViewModel model)
        {
