...
{
    public class PayrollHourController : BaseController
    {

        [HttpGet]
        public ActionResult Panel(byte Co, int EmployeeId, int WeekId)
        {
        ...
        public ActionResult Update(PayrollHourReviewViewModel model)
        {
            using var db = new VPContext();
        ...
        public JsonResult Validate(DailyEmployeePerdiemViewModel model)
        {
            ...
            if (ticket.DailyEmployeePerdiems.Count > 0)
            {
