...
namespace portal.Controllers.View.HR
{
    [ControllerAccess]
    [ControllerAuthorize]
    public class HRRecentlyTermedEmployeeController : BaseController
    {
        [HttpGet]
        [Route("HR/Employees/Termed")]
        public ActionResult Index()
        {
            ...
            ViewBag.DataController = "HRRecentlyTermedEmployee";
        ...
        public ActionResult Data()//string statusId
        {
            ...
            results = new ResourceListViewModel(company, "N");
