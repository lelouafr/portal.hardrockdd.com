...
{
    [ControllerAuthorize]
    public class HRResourceADInfoController : BaseController
    {

        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(ResourceADInfoViewModel model)
        {
            if (model != null)
            {
        ...
        [HttpGet]
        public JsonResult Validate(ResourceADInfoViewModel model)
        {
