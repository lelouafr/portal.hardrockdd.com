...
{
    [ControllerAuthorize]
    public class HRResourceAssignmentController : BaseController
    {

        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(PayrollAssignmentViewModel model)
        {
            if (model != null)
            {
        ...
        [HttpGet]
        public JsonResult Validate(PayrollAssignmentViewModel model)
        {
