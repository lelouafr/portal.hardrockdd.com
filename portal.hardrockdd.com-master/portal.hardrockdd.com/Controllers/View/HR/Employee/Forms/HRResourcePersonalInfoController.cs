...
{
    [ControllerAuthorize]
    public class HRResourcePersonalInfoController : BaseController
    {

        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(PersonalInfoViewModel model)
        {
            if (model != null)
            {
        ...
        [HttpGet]
        public JsonResult Validate(PersonalInfoViewModel model)
        {
