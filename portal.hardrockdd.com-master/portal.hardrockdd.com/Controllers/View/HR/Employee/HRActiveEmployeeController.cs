...
namespace portal.Controllers.View.HR
{
    [ControllerAccess]
    [ControllerAuthorize]
    public class HRActiveEmployeeController : BaseController
    {
        [HttpGet]
        [Route("HR/Employees/Active")]
        public ActionResult Index()
        {
            ...
            ViewBag.DataController = "HRActiveEmployee";
        ...
        public ActionResult Data()//string statusId
        {
            ...
            results = new ResourceListViewModel(company, "Y");
