...
{
    public class DailyGeneralTicketController : BaseController
    {
        [HttpGet]
        public ActionResult Form(byte dtco, int ticketId)
        {
            ...
            var model = (GeneralTicketFormViewModel)modelTicket.DynaimicTicket;
            ...
            return PartialView(model.Ticket);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(Models.Views.DailyTicket.DailyGeneralTicketViewModel model)
        {
            using var db = new VPContext();
        ...
        [HttpGet]
        public JsonResult Validate(Models.Views.DailyTicket.DailyGeneralTicketViewModel model)
        {
            ...
            model = new Models.Views.DailyTicket.DailyGeneralTicketViewModel(ticket);
