...
namespace portal.Code.Data.VP
{
    public class BidBoreLineCost
    {
        ...
        public BidBoreLineCost(Code.Data.VP.BidBoreLine line, Code.Data.VP.BidBoreLineCostItem item, int shiftNum)
        {
            if (line == null)
            {
        ...
        public BidBoreLineCost(Code.Data.VP.BidBoreLine line, Code.Data.VP.BidBoreLineCostItemPhase item, int shiftNum)
        {
            if (line == null)
                return;
            if (item == null)
