    ...
    public partial class CreditTransactionCode
    {
        ...
        public int? POItemTypeId
        {
            ...
            set
            {
                ...
                {
                    UpdatePOItemType((DB.POItemTypeEnum)(value ?? 0));
                }
            }
        }

        public DB.POItemTypeEnum POItemType
        {
            get
            {
                return (DB.POItemTypeEnum)(this.tPOItemTypeId ?? 0);
            }
            set
            {
        ...
        public byte? LineTypeId
        {
            ...
            set
            {
                ...
                {
                    UpdateLineType((DB.CMCodeLineTypeEnum?)value);
                }
            }
        }

        public DB.CMCodeLineTypeEnum? LineType
        {
            get
            {
                return (DB.CMCodeLineTypeEnum?)(this.tLineTypeId);
            }
            set
            {
        ...
        public void UpdatePOItemType(DB.POItemTypeEnum newValue)
        {
            switch (newValue)
            {
        ...
        public void UpdateLineType(DB.CMCodeLineTypeEnum? newValue)
        {
            tGLAcct = null;
            switch (newValue)
            {
        ...
        public void UpdateGLAccountInfo(string newValue)
        {
            ...
            {
                if ((StaticFunctions.GetCurrentEmployee().EmployeeId == Transaction.EmployeeId ||
                                     StaticFunctions.GetCurrentEmployee().ReportsToId == Transaction.EmployeeId))
                {
                    Transaction.CodedStatusId = (int)DB.CMTransCodeStatusEnum.EmployeeCoded;
                    if (Transaction.Status == DB.CMTranStatusEnum.RequestedInfomation)
                    {
                        Transaction.Status = DB.CMTranStatusEnum.Open;
                    }
                    Transaction.Logs.Add(Repository.VP.AP.CreditCard.CreditCardTransactionLogRepository.Init(Transaction, DB.CMLogEnum.EmployeeCoded, "Transaction was coded by Employee"));
                }
                else
                {
                    Transaction.CodedStatusId = (int)DB.CMTransCodeStatusEnum.Coded;
                    if (Transaction.Status == DB.CMTranStatusEnum.RequestedInfomation)
                    {
                        Transaction.Status = DB.CMTranStatusEnum.Open;
                    }
                    Transaction.Logs.Add(Repository.VP.AP.CreditCard.CreditCardTransactionLogRepository.Init(Transaction, DB.CMLogEnum.Coded));
                }
            }
            else if (originalGLAcct != tGLAcct && tGLAcct == null)
            {
                Transaction.CodedStatusId = (int)DB.CMTransCodeStatusEnum.Empty;
                Transaction.Logs.Add(Repository.VP.AP.CreditCard.CreditCardTransactionLogRepository.Init(Transaction, DB.CMLogEnum.Coded));
            }
        }

        public void GetEMGLAccount(VPEntities db)
        {
        ...
        public void GetJCGLAccount(VPEntities db)
        {
