    ...
    public partial class HRCompanyParm
    {
        ...
        public HRTermRequest AddTermRequest()
        {
            var request = new HRTermRequest
            {
                ...
                RequestedBy = StaticFunctions.GetUserId(),
        ...
        public HRTermRequest AddTermRequest(Areas.HumanResource.Models.TermRequest.CreateTermRequestViewModel model)
        {
            if (model == null)
        ...
        public HRPositionRequest AddPositionRequest(Areas.HumanResource.Models.PositionRequest.CreateRequestViewModel model)
        {
            if (model == null)
