...
namespace portal.Code.Data.VP
{
    public partial class APDocumentLine
    {
        ...
        public DB.TaxTypeEnum? TaxType
        {
            get
            {
                return (DB.TaxTypeEnum?)TaxTypeId;
            }
            set
            {
        ...
        public DB.APLineTypeEnum LineType
        {
            get
            {
                return (DB.APLineTypeEnum)this.LineTypeId;
            }
            set
            {
        ...
        private void UpdateLineType(byte newValue)
        {
            ...
            switch (LineType)
            {
                case DB.APLineTypeEnum.Expense:
                    ...
                    PurchaseOrder = null;
                    POItem = null;
                    tGLAcct = Header.Vendor.GLAcct;
                    GLCo = Header.Vendor.GLCo;
                    break;
        ...
        public DB.POItemTypeEnum? POItemType
        {
            get
            {
                return (DB.POItemTypeEnum?)POItemTypeId;
            }
            set
            {
        ...
        private void UpdatePOItemType(DB.POItemTypeEnum newValue)
        {
            switch (newValue)
            {
        ...
        public string PO
        {
            ...
            set
            {
                if (LineType == DB.APLineTypeEnum.PO)
                {
                    if (value != tPO)
                    {
                        UpdatePO(value);
        ...
        private void UpdateGLAccount(string newValue)
        {
            switch (LineType)
            {
                case DB.APLineTypeEnum.Job:
                    ...
                    break;
                case DB.APLineTypeEnum.Expense:
                    GLCo = this.Header.Document.APCompanyParm.GLCo;
                    tGLAcct = newValue;
                    break;
                case DB.APLineTypeEnum.Equipment:
                    if (Equipment != null)
