    ...
    public partial class APDocumentSeq
    {
        ...
        public APDocumentLine AddLine(PurchaseOrderItem poItem)
        {
            ...
            var line = new APDocumentLine
            {
                ...
                LineTypeId = (byte)DB.APLineTypeEnum.PO,
                UM = poItem.UM,
            ...
            switch ((DB.POItemTypeEnum)poItem.ItemTypeId)
            {
        ...
        public APDocumentLine AddLine()
        {
            var line = new APDocumentLine
            {
                ...
                SeqId = SeqId,
                LineId = (short)(Lines.DefaultIfEmpty().Max(max => max == null ? 0 : max.LineId) + 1),
                LineTypeId = (byte)DB.APLineTypeEnum.Job,
            ...
            if (PO != null)
            {
                line.POCo = POCo;
                line.PO = PO;
                line.LineTypeId = (byte)DB.APLineTypeEnum.PO;
            }
            Lines.Add(line);
            return line;
        }
