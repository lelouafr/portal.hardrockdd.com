...
namespace portal.Code.Data.VP
{
    public static class EMAuditExtension
    {
        public static bool IsAuditLate(this EMAudit audit, DailyTicket ticket)
        {
            ...
            if ((audit.Status == DB.EMAuditStatusEnum.New ||
                 audit.Status == DB.EMAuditStatusEnum.Rejected ||
                 audit.Status == DB.EMAuditStatusEnum.Started))
            {
    ...
    public partial class EMAudit
    {
        ...
        public DB.EMAuditFormEnum AuditForm
        {
            get
            {
                return (DB.EMAuditFormEnum)AuditFormId;
            }
            set
            {
        ...
        public DB.EMAuditStatusEnum Status
        {
            get
            {
                return (DB.EMAuditStatusEnum)StatusId;
            }
            set
            {
        ...
        public DB.EMAuditTypeEnum AuditType
        {
            get
            {
                return (DB.EMAuditTypeEnum)AuditTypeId;
            }
            set
            {
        ...
        public void UpdateStatus()
        {
            ...
            switch (Status)
            {
                ...
                case DB.EMAuditStatusEnum.Approved:
                    //if (EMParameter.AuditAutoProcess == "Y" || AuditForm == DB.EMAuditFormEnum.Inventory)
                    //{
                    //    Status = DB.EMAuditStatusEnum.Processed;
                    //    return;
                    //}
                    ...
                    Status = DB.EMAuditStatusEnum.Processed;
                    WorkFlow.CurrentSequance().Comments = "Auto Processed";
        ...
        {
            var newLines = Lines.Where(f => f.ActionId == (int)DB.EMAuditLineActionEnum.Add).ToList();
            ...
            foreach (var line in newLines)
            {
                ...
                {
                    cur.Completed = true;
                    cur.ActionId = (int)DB.EMAuditLineActionEnum.Transfer;
                    ...
                    switch (AuditType)
                    {
                        case DB.EMAuditTypeEnum.CrewAudit:
                            ...
                            cur.Equipment.AssignmentType = (int)DB.EMAssignmentTypeEnum.Crew;
                            cur.Comments = string.Format(AppCultureInfo.CInfo(), "Equipment was auto transfered by {0} {1} to Crew {2}.  User added to their Eqp Audit.",
                        ...
                        case DB.EMAuditTypeEnum.EmployeeAudit:
                            ...
                            cur.Comments = string.Format(AppCultureInfo.CInfo(), "Equipment was auto transfered by {0} {1} to Employee {2}.  User added to their Eqp Audit.",
                                                            AssignedUser.FirstName,
                                                            AssignedUser.LastName,
                                                            ParmEmployeeId);
                            break;
                        case DB.EMAuditTypeEnum.LocationAudit:
                            ...
                            cur.Equipment.AssignmentType = (int)DB.EMAssignmentTypeEnum.Employee;
                            cur.Comments = string.Format(AppCultureInfo.CInfo(), "Equipment was auto transfered by {0} {1} to Location {2}.  User added to their Eqp Audit.",
                                                            AssignedUser.FirstName,
                                                            AssignedUser.LastName,
                                                            ParmLocationId);
                            break;
        ...
        private void GenerateEquipmentLog()
        {
            foreach (var line in Lines)
            {
                ...
                if (AuditFormId == (int)DB.EMAuditFormEnum.Inventory)
                {
                    log.LogTypeId = 1;
                }
                log.SeqId = seqId;
                ...
                switch (AuditType)
                {
                    case DB.EMAuditTypeEnum.CrewAudit:
                        ...
                        if (line.ActionId == (int)DB.EMAuditLineActionEnum.Transfer)
                        {
                        ...
                        else if (line.ActionId == (int)DB.EMAuditLineActionEnum.Add)
                        {
                        ...
                        else if (line.ActionId == (int)DB.EMAuditLineActionEnum.Update)
                        {
                            log.CrewConfirmed = line.Completed;
                            log.FromCrewId = line.Equipment.AssignedCrewId;
                            log.ToCrewId = ParmCrewId;
                        ...
                        line.Equipment.AssignmentType = line.Equipment.AssignmentType ?? (int)DB.EMAssignmentTypeEnum.Crew;
                    ...
                    case DB.EMAuditTypeEnum.EmployeeAudit:
                        ...
                        else if (line.ActionId == (int)DB.EMAuditLineActionEnum.Add || line.ActionId == (int)DB.EMAuditLineActionEnum.Update)
                        {
                        ...
                        line.Equipment.AssignmentType = line.Equipment.AssignmentType ?? (int)DB.EMAssignmentTypeEnum.Employee;
                        line.Equipment.OperatorId = log.ToEmployeeId;
                        line.Equipment.LocationId = log.ToLocationId;
                        //line.Equipment.AssignedCrewId = log.ToCrewId;
                        break;
                    case DB.EMAuditTypeEnum.LocationAudit:
                        if (line.Action == DB.EMAuditLineActionEnum.Transfer)
                        {
        ...
        {
            if (AuditForm == DB.EMAuditFormEnum.Meter)
            {
                var batchLines = Lines.Where(f => (f.Action == DB.EMAuditLineActionEnum.Add || f.Action == DB.EMAuditLineActionEnum.Update) &&
                                                   f.Completed == true &&
