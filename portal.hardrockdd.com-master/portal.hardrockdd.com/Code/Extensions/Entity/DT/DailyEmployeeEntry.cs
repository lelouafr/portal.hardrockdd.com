    ...
    public partial class DailyEmployeeEntry
    {
        ...
        public int? EntryTypeId
        {
            ...
            set
            {
                ...
                {
                    UpdateEntryType((DB.EntryTypeEnum)(value ?? 0));
                }
            }
        }
        ...
        public DB.EntryTypeEnum? EntryType
        {
            get
            {
                return (DB.EntryTypeEnum)(this.tEntryTypeId ?? 0);
            }
            set
            {
                EntryTypeId = (int)(value ?? DB.EntryTypeEnum.Admin);
            }
        }
        ...
        private void UpdateEntryType(DB.EntryTypeEnum newValue)
        {
            switch (newValue)
            {
        ...
        public DTPayrollHour InitDTPayRollHourEntry()
        {
            ...
            switch (EntryType)
            {
                ...
                case DB.EntryTypeEnum.Job:
                    ...
                    if (Job.JobType == DB.JCJobTypeEnum.ShopYard)
                    {
                        entry.Job = null;
                        entry.JCCo = null;
                        entry.JobId = null;
