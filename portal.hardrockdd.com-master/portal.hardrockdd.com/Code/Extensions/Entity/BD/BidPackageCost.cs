...
namespace portal.Code.Data.VP
{
    public partial class BidPackageCost
    {
        ...
        public DB.BDPackageCostAllocationType? CostAllocationType
        {
            get
            {
                return (DB.BDPackageCostAllocationType?)tCostAllocationTypeId;
            }
            set
            {
                if ((DB.BDPackageCostAllocationType?)tCostAllocationTypeId != value)
                {
