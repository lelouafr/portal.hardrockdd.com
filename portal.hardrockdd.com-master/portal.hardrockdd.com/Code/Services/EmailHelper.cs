    ...
    public class EmailHelper
    {
        ...
        public static void Send(MailMessage message, bool noTest = true)
        {
            ...
            if (HttpContext.Current != null)
            {
                ...
                //    message.Subject = string.Format(AppCultureInfo.CInfo(), "{0}: {1}", "TEST SYSTEM EMAIL", message.Subject);
                //    client.Send(message);
                //}
            }
            else
        ...
        public static string RenderViewToString(string controller, string action, string area, string viewPath,
                                    object model = null,
                                    bool partial = false)
        {
            var context = HttpContext.Current;
