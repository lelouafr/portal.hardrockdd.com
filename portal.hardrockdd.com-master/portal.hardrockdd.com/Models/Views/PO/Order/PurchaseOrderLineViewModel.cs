...
namespace portal.Models.Views.Purchase.Order
{
    public class PurchaseOrderItemListViewModel
    {
        ...
        public PurchaseOrderItemListViewModel(DB.Infrastructure.ViewPointDB.Data.PurchaseOrder purchaseOrder)
        {
            if (purchaseOrder == null)
            {
                throw new System.ArgumentNullException(nameof(purchaseOrder));
            }
            Co = purchaseOrder.POCo;
            PO = purchaseOrder.PO;

            List = purchaseOrder.Items.Select(s => new PurchaseOrderItemViewModel(s)).ToList();
        }

        public PurchaseOrderItemListViewModel(DB.Infrastructure.ViewPointDB.Data.Job job)
        {
            if (job == null)
            {
            ...
            List = job.POItems.Select(s => new PurchaseOrderItemViewModel(s)).ToList();
        }
        ...
        public List<PurchaseOrderItemViewModel> List { get; }
    }
    ...
    public class PurchaseOrderItemViewModel
    {
        ...
        public PurchaseOrderItemViewModel(DB.Infrastructure.ViewPointDB.Data.PurchaseOrderItem entry)
        {
            if (entry == null)
            {
