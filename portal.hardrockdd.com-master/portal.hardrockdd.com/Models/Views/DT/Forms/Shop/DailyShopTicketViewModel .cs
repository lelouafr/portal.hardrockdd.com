...
namespace portal.Models.Views.DailyTicket
{
    ...
    public class DailyShopTicketViewModel : AuditBaseViewModel
    {
        public DailyShopTicketViewModel()
        {

        }
        public DailyShopTicketViewModel(DB.Infrastructure.ViewPointDB.Data.DailyShopTicket ticket):base(ticket) 
        {
            if (ticket == null)
            {
        ...
        public DailyShopTicketViewModel(DB.Infrastructure.ViewPointDB.Data.DailyTicket ticket) : base(ticket == null ? throw new ArgumentNullException(nameof(ticket)) : ticket.DailyShopTicket)
        {
            if (ticket == null)
            {
        ...
        internal DailyShopTicketViewModel ProcessUpdate(VPContext db, ModelStateDictionary modelState)
        {
            ...
            if (updObj != null)
            {
                ...
                try
                {
                    ...
                    return new DailyShopTicketViewModel(updObj);
                }
                catch (Exception ex)
                {
