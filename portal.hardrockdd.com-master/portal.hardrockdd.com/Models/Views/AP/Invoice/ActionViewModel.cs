...
namespace portal.Models.Views.AP.Invoice
{
    public class ActionViewModel
    {
        ...
        public ActionViewModel(DB.Infrastructure.ViewPointDB.Data.APTran entity)
        {
            if (entity == null)
            {
        ...
        [Required]
        [UIHint("DropdownBox")]
        [Field(LabelSize = 2, TextSize = 4, ComboUrl = "/GLAccount/APMthCombo", ComboForeignKeys = "GLCo")]
