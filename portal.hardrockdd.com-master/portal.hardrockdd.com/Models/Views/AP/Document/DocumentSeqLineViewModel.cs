...
{
    public class DocumentSeqLineListViewModel
    {
        public DocumentSeqLineListViewModel()
        {

        }

        public DocumentSeqLineListViewModel(APDocument document) 
        {
            ...
            List = document.Lines.Select(s => new DocumentSeqLineViewModel(s)).ToList();            
        }
        ...
        public List<DocumentSeqLineViewModel> List { get; }
    }

    public class DocumentSeqLineViewModel
    {
        public DocumentSeqLineViewModel()
        {

        }

        public DocumentSeqLineViewModel(DB.Infrastructure.ViewPointDB.Data.APDocumentLine documentLine)
        {
        ...
        [UIHint("DropdownBox")]
        [Field(LabelSize = 3, TextSize = 3, ComboUrl = "/POCombo/POItemCombo", ComboForeignKeys = "POCo, PO")]
        [Display(Name = "Item")]
