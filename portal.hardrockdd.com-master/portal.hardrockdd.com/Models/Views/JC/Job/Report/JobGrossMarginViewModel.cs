...
namespace portal.Models.Views.JC.Job.Report
{
    public class JobGrossMarginListViewModel
    {
        public JobGrossMarginListViewModel()
        {

        }

        public JobGrossMarginListViewModel(DateTime mth)
        {
            ...
            List = jobList.Select(s => new JobGrossMarginViewModel(s, mth)).ToList();
        ...
        public List<JobGrossMarginViewModel> List { get; set; }
    }

    public class JobGrossMarginViewModel
    {
        public JobGrossMarginViewModel()
        {

        }

        public JobGrossMarginViewModel(DB.Infrastructure.ViewPointDB.Data.Job job, DateTime mth)
        {
            Mth = mth;
            JCCo = job.JCCo;
            JobId = job.JobId;
