...
namespace portal.Models.Views.WA.Applicant
{
    public class ApplicantInfoViewModel
    {
        ...
        public ApplicantInfoViewModel(Code.Data.VP.WebApplicant applicant)
        {
            if (applicant == null)
                return;
            ...
            Actions = new Application.ActionViewModel(applicant.CurrentApplication());
        }
        ...
        public Application.ActionViewModel Actions { get; set; }
        ...
        internal ApplicantInfoViewModel ProcessUpdate(VPEntities db, ModelStateDictionary modelState)
        {
