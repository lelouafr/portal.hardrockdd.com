...
namespace portal.Models.Views.WA.Application
{
    public class EquipmentHistoryListViewModel
    {
        ...
        public EquipmentHistoryListViewModel(Code.Data.VP.WebApplication application)
        {
            if (application == null)
                return;
    ...
    public class EquipmentHistoryViewModel
    {
        ...
        public EquipmentHistoryViewModel(Code.Data.VP.WADrivingExperience experience)
        {
            if (experience == null)
                return;
        ...
        internal EquipmentHistoryViewModel ProcessUpdate(VPEntities db, ModelStateDictionary modelState)
        {
