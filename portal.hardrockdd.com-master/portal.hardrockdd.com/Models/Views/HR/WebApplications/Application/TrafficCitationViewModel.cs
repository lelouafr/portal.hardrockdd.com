...
namespace portal.Models.Views.WA.Application
{
    public class TrafficCitationListViewModel
    {
        ...
        public TrafficCitationListViewModel(Code.Data.VP.WebApplication application)
        {
            if (application == null)
                return;
            ...
            List = application.TrafficIncidents.Where(f => f.IncidentType == WAIncidentTypeEnum.Citation).Select(s => new TrafficCitationViewModel(s)).ToList();
        }
    ...
    public class TrafficCitationViewModel
    {
        ...
        public TrafficCitationViewModel(Code.Data.VP.WATrafficIncident incident)
        {
            if (incident == null)
                return;
        ...
        internal TrafficCitationViewModel ProcessUpdate(VPEntities db, ModelStateDictionary modelState)
        {
