...
namespace portal.Models.Views.WA.Application
{
    public class DrugTestListViewModel
    {
        ...
        public DrugTestListViewModel(Code.Data.VP.WebApplication application)
        {
            if (application == null)
                return;
    ...
    public class DrugTestViewModel
    {
        ...
        public DrugTestViewModel(Code.Data.VP.WAApplicantDrugTest drugTest)
        {
            if (drugTest == null)
                return;
        ...
        internal DrugTestViewModel ProcessUpdate(VPEntities db, ModelStateDictionary modelState)
        {
