...
{
    public class ResourceInfoViewModel : AuditBaseViewModel
    {
        ...
        public ResourceInfoViewModel(HRResource resource) : base(resource)
        {
        ...
        internal ResourceInfoViewModel ProcessUpdate(ModelStateDictionary modelState, VPEntities db)
        {
            if (db == null) throw new ArgumentNullException(nameof(db));

            var updObj = db.HRResources.Where(f => f.HRCo == this.HRCo && f.HRRef == this.ResourceId).FirstOrDefault();
            ...
            if (updObj != null)
            {
                ...
                try
                {
                    ...
                    return new ResourceInfoViewModel(updObj);
                }
                catch (Exception ex)
                {
