...
{
    public class ResourceAssignedAssetListViewModel
    {
        public ResourceAssignedAssetListViewModel()
        {
            List = new List<ResourceAssignedAssetViewModel>();
        }


        public ResourceAssignedAssetListViewModel(HRResource resource)
        {
            ...
            List = resource.AssignedAssets.Select(s => new ResourceAssignedAssetViewModel(s)).ToList();
        }
        ...
        public List<ResourceAssignedAssetViewModel> List { get;  }
    }

    public class ResourceAssignedAssetViewModel
    {
        public ResourceAssignedAssetViewModel()
        {

        }
        
        public ResourceAssignedAssetViewModel(Code.Data.VP.HRAssetAssignment assetAssignment)
        {
