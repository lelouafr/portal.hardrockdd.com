...
namespace portal.Models.Views.HR.Request.Position
{
    public class RequestListViewModel
    {
        ...
        public RequestListViewModel(Code.Data.VP.WebUser user)
        {
            if (user == null)
                return;
        ...
        public RequestListViewModel(Code.Data.VP.VPEntities db)
        {
            if (db == null)
                return;
            var termList = db.HRPositionRequests.ToList();//.Where(f => f.tStatusId != (int)HRPositionRequestStatusEnum.Hire)
            List = termList.Select(s => new RequestViewModel(s)).ToList();

        }

        public RequestListViewModel(List<Code.Data.VP.HRPositionRequest> list)
        {
            if (list == null)
                return;
    ...
    public class RequestViewModel
    {
        ...
        public RequestViewModel(Code.Data.VP.HRPositionRequest request)
        {
            if (request == null)
                return;
        ...
        internal RequestViewModel ProcessUpdate(Code.Data.VP.VPEntities db, System.Web.Mvc.ModelStateDictionary modelState)
        {
