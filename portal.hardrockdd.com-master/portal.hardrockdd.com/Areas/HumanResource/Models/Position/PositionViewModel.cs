...
namespace portal.Areas.HumanResource.Models.Position
{
    public class PositionListViewModel
    {
        ...
        public PositionListViewModel(HRCompanyParm companyParm)
        {
            if (companyParm == null)
                return;
    ...
    public class PositionViewModel
    {
        ...
        public PositionViewModel(HRPosition position)
        {
            if (position == null)
                return;
        ...
        internal PositionViewModel ProcessUpdate(VPContext db, System.Web.Mvc.ModelStateDictionary modelState)
        {
