...
namespace portal.Areas.HumanResource.Models.Position
{
    public class TaskListViewModel
    {
        ...
        public TaskListViewModel(VPContext db)
        {
            if (db == null)
                return;
    ...
    public class TaskViewModel
    {
        ...
        public TaskViewModel(HRTask task)
        {
            if (task == null)
                return;
        ...
        internal TaskViewModel ProcessUpdate(VPContext db, System.Web.Mvc.ModelStateDictionary modelState)
        {
