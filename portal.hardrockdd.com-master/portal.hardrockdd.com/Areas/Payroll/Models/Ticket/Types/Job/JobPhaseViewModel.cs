...
{
    public class JobPhaseListViewModel
    {

        public JobPhaseListViewModel()
        {

        }

        public JobPhaseListViewModel(DailyJobTicket jobTicket)
        {
            if (jobTicket == null)
                return;
            ...
            List = jobTicket.DTJobPhases.Select(s => new JobPhaseViewModel(s)).ToList();
        }
        ...
        public List<JobPhaseViewModel> List { get; }
    }

    public class JobPhaseViewModel
    {

        public JobPhaseViewModel()
        {

        }

        public JobPhaseViewModel(DTJobPhase dailyPhase)
        {
            if (dailyPhase == null)
                return;
            ...
            Costs = dailyPhase.DTCostLines.Select(s => new JobPhaseCostViewModel(s)).ToList();
        }
        ...
        public List<JobPhaseCostViewModel> Costs { get; }

    }

    public class JobPhaseCostViewModel
    {
        public JobPhaseCostViewModel()
        {

        }

        public JobPhaseCostViewModel(DB.Infrastructure.ViewPointDB.Data.DTJobPhaseCost dailyPhaseCost)
        {
        ...
        internal JobPhaseCostViewModel ProcessUpdate(VPContext db, ModelStateDictionary modelState)
        {
            ...
            if (updObj != null)
            {
                ...
                try
                {
                    ...
                    return new JobPhaseCostViewModel(updObj);
                }
                catch (Exception ex)
                {
