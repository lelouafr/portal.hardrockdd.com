...
namespace portal.Areas.Project.Models.Bid.Bore
{
    ...
    public class ProductionRateViewModel
    {
        ...
        public ProductionRateViewModel(List<DB.Infrastructure.ViewPointDB.Data.BidBoreLinePass> rates, BidBoreLine line)
        {
            ...
            PhaseDescription = rate.PhaseMaster?.Description;
            PassId = rate.PassId;
        ...
        internal ProductionRateViewModel ProcessUpdate(VPContext db, ModelStateDictionary modelState)
        {
            ...
            if (updObjs.Any())
            {
                ...
                if (DualShift)
                {
                    if (dirtRate.ShiftCnt != 2)
                    {
                        dirtRate.ShiftCnt = 2;
                        dirtRate.Shift2ProductionPerc = .5m;
                ...
                {
                    if (dirtRate.ShiftCnt != null)
                    {
                        dirtRate.ShiftCnt = null;
                        dirtRate.Shift2ProductionPerc = null;
                        bore.RecalcNeeded = true;
                    }
                }
                ...
                if (DualShift)
                {
                    if (rockRate.ShiftCnt != 2)
                    {
                        rockRate.ShiftCnt = 2;
                        rockRate.Shift2ProductionPerc = .5m;
                        bore.RecalcNeeded = true;
                    }
                ...
                {
                    if (rockRate.ShiftCnt != null)
                    {
                        rockRate.ShiftCnt = null;
                        rockRate.Shift2ProductionPerc = null;
                        bore.RecalcNeeded = true;
                    }
                }
