...
namespace portal.Areas.Applicant.Models
{
    public class LicenseInfoViewModel
    {
        ...
        public LicenseInfoViewModel(DB.Infrastructure.ViewPointDB.Data.WebApplicant applicant)
        {
            if (applicant == null)
                return;
        ...
        internal LicenseInfoViewModel ProcessUpdate(VPContext db, ModelStateDictionary modelState)
        {
