...
namespace portal.Areas.Applicant.Models
{
    public class WorkHistoryListViewModel
    {
        ...
        public WorkHistoryListViewModel(DB.Infrastructure.ViewPointDB.Data.WebApplication application)
        {
            if (application == null)
                return;
    ...
    public class WorkHistoryViewModel
    {
        ...
        public WorkHistoryViewModel(DB.Infrastructure.ViewPointDB.Data.WAWorkExperience experience)
        {
            if (experience == null)
                return;
        ...
        internal WorkHistoryViewModel ProcessUpdate(VPContext db, ModelStateDictionary modelState)
        {
