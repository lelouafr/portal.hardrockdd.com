...
namespace portal.Areas.Job.Models.Contract
{
    public class ContractViewModel
    {
        ...
        public ContractViewModel(JCContract contract)
        {
            if (contract == null)
                return;
        ...
        internal ContractViewModel ProcessUpdate(ModelStateDictionary modelState, VPContext db)
        {
            ...
            if (updObj != null)
            {
                ...
                updObj.PayTerms = this.PayTermId;
                updObj.DepartmentId = this.DepartmentId;
                updObj.CustomerReference = this.CustomerRef;
                try
                {
