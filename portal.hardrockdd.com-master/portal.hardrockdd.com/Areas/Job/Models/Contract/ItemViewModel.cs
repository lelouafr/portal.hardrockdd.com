...
namespace portal.Areas.Job.Models.Contract
{
    public class ItemListViewModel
    {
        ...
        public ItemListViewModel(DB.Infrastructure.ViewPointDB.Data.JCContract contract)
        {
            if (contract == null) return;

            Co = contract.JCCo;
            ContractId = contract.ContractId;
            List = contract.ContractItems.Select(s => new ItemViewModel(s)).ToList();
        }
    ...
    public class ItemViewModel
    {
        ...
        public ItemViewModel(DB.Infrastructure.ViewPointDB.Data.ContractItem contractItem)
        {
