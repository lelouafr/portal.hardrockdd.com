...
namespace DB.Infrastructure.ViewPointDB.Data
{
    public partial class BidBoreLinePass
    {
        ...
        public BidProductionCalEnum ProductionCalType
        {
            get
            {
                return (BidProductionCalEnum)(ProductionCalTypeId ?? 0);
            }
            set
            {
                if (value != (BidProductionCalEnum)(ProductionCalTypeId ?? 0))
                {
        ...
        public decimal? ProductionValue
        {
            get
            {
                ...
                {
                    BidProductionCalEnum.Rate => ProductionRate ?? 0,
                    BidProductionCalEnum.Days => ProductionDays ?? 0,
                    _ => 0,
                };
            }
            set
            {
                ...
                if (originalVal != value)
                {
                    ...
                    {
                        case BidProductionCalEnum.Rate:
                            ...
                            break;
                        case BidProductionCalEnum.Days:
        ...
        public decimal? BoreSize
        {
            ...
            set
            {
                if (tBoreSize != value)
                {
                    ...
                    this.BoreLine.RecalcNeeded = true;
        ...
        public decimal? Duration
        {
            get
            {
                return ProductionCalType switch
                {
                    BidProductionCalEnum.Rate => ProductionDays,
                    BidProductionCalEnum.Days => BoreLine.Footage == 0 || ProductionRate == 0 ? 0 : BoreLine.Footage / ProductionRate,
                    _ => 0,
                };
            }
            set
        ...
        {
            var groundDensityStr = GroundDensityId.ToString(VPContext.AppCultureInfo);
            var bgt = BoreLine
                        .Bid
                        .Company
                        .PMCompanyParm
