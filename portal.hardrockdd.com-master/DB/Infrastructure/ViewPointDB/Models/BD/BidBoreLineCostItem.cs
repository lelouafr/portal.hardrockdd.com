        ...
        public void ReCalulateCostItem()
        {
            ...
            if (!skipCostitem)
            {
                if (BudgetCode.UM == "BBL")
                {
                    ...
                    if (BoreLine.Bid.Status <= BidStatusEnum.ContractApproval)
                    {
                ...
                if (BudgetCode.UM == "DYS" || BudgetCode.UM == "MOS")
                {
                    ...
                    foreach (var pass in costPhases)
                    {
                        ...
                        else
                        {
                            ...
                            if (pass.ProductionCalTypeId == (int)BidProductionCalEnum.Rate)
                            {
                            ...
                            else if (pass.ProductionCalTypeId == (int)BidProductionCalEnum.Days)
                            {
