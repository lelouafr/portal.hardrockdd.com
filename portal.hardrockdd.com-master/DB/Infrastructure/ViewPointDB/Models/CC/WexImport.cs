    ...
    public partial class CCWexImport
    {
        ...
        public void SetEmployee()
        {
            ...
            else
            {
                ...
                var asset = Import.CompanyAssets.FirstOrDefault(f => f.HRCo == this.Import.HQCompanyParm.HRCo && f.AssetCategory.ToLower() == "cc" && f.Manufacturer.ToLower() == "wex" && f.Identifier == DriverPromptId.ToString());
                if (asset != null)
                {
            ...
            if (TransactionDate != null && TransactionTime != null && DriverPromptId != null)
            {
                ...
                if (transaction == null)
                {
                    ...
                    transaction = new CreditTransaction()
                    {
                        ...
                        db = db,
                        Merchant = Merchant,
                        PictureStatusId = (int)CMPictureStatusEnum.NotNeeded,
                    };
