...
namespace DB.Infrastructure.ViewPointDB.Data
{
    ...
    public partial class DailyShopTicket
    {
        ...
        public void GenerateEmployeeList()
        {
            ...
            if (DailyTicket.FormType == DTFormEnum.ShopTicket)
            {
                ...
                var lastTicket = db.DailyShopTickets.Where(f =>
                                                            ...
                                                            f.DailyTicket.tStatusId != (int)DailyTicketStatusEnum.Canceled &&
                                                            f.DailyTicket.tStatusId != (int)DailyTicketStatusEnum.Deleted &&
                                                            f.DailyTicket.tStatusId != (int)DailyTicketStatusEnum.Rejected)
        ...
        public DailyEmployeeEntry AddHoursEntry()
        {
            ...
            if (Job != null)
            {
                ...
                entry.JCCo = JCCo;
                entry.Job = Job;
                entry.EntryTypeId = (int)EntryTypeEnum.Job;
            }
